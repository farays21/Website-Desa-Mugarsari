...
interface NewsItem { id: string; title: string; created_at: string }
      ...
      <section className="bg-gray-300 rounded-xl p-4">
        ...
        <div className="flex gap-2 mb-3">
          <input
            ...
            className="flex-1 px-3 py-2 bg-white border border-gray-300 rounded text-sm focus:outline-none focus:border-[#1a7a2e]"
          />
          <button onClick={addNews} disabled={loading || !newTitle.trim()}
            className="px-4 py-2 bg-[#1a7a2e] text-white text-sm rounded hover:bg-[#155a22] disabled:opacity-60 transition-colors">
            + Tambah
          </button>
        </div>
